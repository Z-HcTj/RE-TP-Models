...
%% Data
Output_name = {'1_HeadBC_Unsat_results.mat', '2_Base_results.mat', '3_HeadBC_Ponding_results.mat'};
% RE water content
re_thew_plot = [];
% TP water content
tp_thew_plot = [];
...
re_wc_name = {"HeadBC Unsat RE" "Base RE" "HeadBC Ponding RE"};
tp_wc_name = {"HeadBC Unsat TP" "Base TP" "HeadBC Ponding TP"};
figure
hold on
for ii = 1:3
...
%% RID plot
RID_name = {"HeadBC Unsat" "Base" "HeadBC Ponding"};
figure
hold on
for ii = 1:3
