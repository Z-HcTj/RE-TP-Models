...
% Boundary condition
% UH scenario (unsaturated)
thew_bd = 0.9*thews(2,1);
pw_bd = thewtranpwVG(thew_bd,phi(1,2),thewr(1,2),thenr(1,2),n(1,2),m(1,2),a(1,2),rhow0,g);
% % ESH scenario (exactly saturated)
% pw_bd = 0 * rhow0 * g;
% % PH scenario (Ponding)
% pw_bd = 0.05 * rhow0 * g;
