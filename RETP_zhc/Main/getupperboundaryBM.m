function [thewtop, pwtop, qout] = getupperboundaryBM(MVG_option,hc_mvg,rhow0,pw1,pw1_ex,pw2,thew2,qw,dz,n,m,k,vw,a,g,gr,thewr,thenr,phi,epw)
...
while 1
    if pw1 < 0
        thew1 = pwtranthewVG(MVG_option,hc_mvg,pw1,phi,thewr,thenr,n,m,a,rhow0,g);
    else
        thew1 = phi - thenr;
    end
