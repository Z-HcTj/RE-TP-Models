...
a(:,:) = 2.434;
pcm = rhow0 * g ./ a;
k(:,:) = key_param(ii) * 0.01 / 86400 / (rhow0 * g / vw);
phi(:,:) = 0.43;
thewr(:,:) = 0;
thenr(:,:) = 0;
thews(:,:) = phi - thenr;
...
if key_param(ii) >= 400 && key_param(ii) <= 800
    dt_max = 5;
elseif key_param(ii) >= 200 && key_param(ii) <= 400
    dt_max = 10;
elseif key_param(ii) >= 100 && key_param(ii) < 200
    dt_max = 20;
elseif key_param(ii) >= 50 && key_param(ii) < 100
    dt_max = 40;
elseif key_param(ii) >= 20 && key_param(ii) < 50
    dt_max = 80;
elseif key_param(ii) >= 10 && key_param(ii) < 20
    dt_max = 160;
elseif key_param(ii) && key_param(ii) < 10
    dt_max = 320;
elseif key_param(ii) < 5
    dt_max = 640;
else
    error('k 值超出范围'); 
end
